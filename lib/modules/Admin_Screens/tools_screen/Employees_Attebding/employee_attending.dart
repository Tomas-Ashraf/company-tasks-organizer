// ignore_for_file: prefer_const_constructors, sort_child_properties_last, prefer_const_literals_to_create_immutables, sized_box_for_whitespace, avoid_print, deprecated_member_use, non_constant_identifier_names
...
class EmployeesAttending extends StatefulWidget {
  const EmployeesAttending({Key? key}) : super(key: key);

  static String id = 'EmployeesAttending';

  @override
  State<EmployeesAttending> createState() => _EmployeesAttendingState();
}

class _EmployeesAttendingState extends State<EmployeesAttending> {
        ...
        builder: (context, snapshot) {
          {
            if (snapshot.hasData) {
              return Scaffold(
                appBar: AppBar(
                  title: Text(translator.translate('employeesAttending')),
                ),
                body: Padding(
